...
AObserverProjectile::AObserverProjectile() 
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &AObserverProjectile::OnHit);		// set up a notification for when this component hits something
...
void AObserverProjectile::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
