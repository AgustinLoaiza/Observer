...
#include "Observer/NaveEnemiga.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	OBSERVER_API UClass* Z_Construct_UClass_USuscriptora_NoRegister();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANaveEnemiga_Statics::NewProp_mallaNaveEnemiga = { "mallaNaveEnemiga", nullptr, (EPropertyFlags)0x00200800000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANaveEnemiga, mallaNaveEnemiga), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ANaveEnemiga_Statics::NewProp_mallaNaveEnemiga_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANaveEnemiga_Statics::NewProp_mallaNaveEnemiga_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANaveEnemiga_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ANaveEnemiga_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_USuscriptora_NoRegister, (int32)VTABLE_OFFSET(ANaveEnemiga, ISuscriptora), false },
			{ Z_Construct_UClass_USocorro_NoRegister, (int32)VTABLE_OFFSET(ANaveEnemiga, ISocorro), false },
		};
	...
	IMPLEMENT_CLASS(ANaveEnemiga, 1467550331);
	template<> OBSERVER_API UClass* StaticClass<ANaveEnemiga>()
	{
		return ANaveEnemiga::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ANaveEnemiga(Z_Construct_UClass_ANaveEnemiga, &ANaveEnemiga::StaticClass, TEXT("/Script/Observer"), TEXT("ANaveEnemiga"), false, nullptr, nullptr, nullptr);
