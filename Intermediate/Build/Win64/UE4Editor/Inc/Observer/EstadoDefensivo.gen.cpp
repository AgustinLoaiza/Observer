...
#include "Observer/EstadoDefensivo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	OBSERVER_API UClass* Z_Construct_UClass_AEstadoDefensivo_NoRegister();
	OBSERVER_API UClass* Z_Construct_UClass_AEstadoDefensivo();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEstadoDefensivo_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AEstadoDefensivo_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UEstadosNaveNodriza_NoRegister, (int32)VTABLE_OFFSET(AEstadoDefensivo, IEstadosNaveNodriza), false },
		};
	...
	IMPLEMENT_CLASS(AEstadoDefensivo, 787930985);
	template<> OBSERVER_API UClass* StaticClass<AEstadoDefensivo>()
	{
		return AEstadoDefensivo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AEstadoDefensivo(Z_Construct_UClass_AEstadoDefensivo, &AEstadoDefensivo::StaticClass, TEXT("/Script/Observer"), TEXT("AEstadoDefensivo"), false, nullptr, nullptr, nullptr);
